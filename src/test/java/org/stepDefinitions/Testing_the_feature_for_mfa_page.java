...
public class Testing_the_feature_for_mfa_page extends Base{
	...
	public void user_checks_the_texts_of_the_header(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the mfaPage header properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_the_texts_of_the_cards(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the mfaPage cards properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_the_texts_of_the_footer(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the mfaPage footer properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
