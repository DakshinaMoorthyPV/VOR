...
public class Testing_the_feature_for_reset_password_page extends Base{
	...
	public void user_checks_the_texts_of_the_header(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the length of text in header",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the presence of link in header",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the CSS properties of header",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		logger.info("Validated the resetPasswordPage header properties");
		extentTest.log(LogStatus.PASS,"Validated the resetPasswordPage header properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_the_texts_of_the_cards(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the presence of image in cards",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		FWUtils.checksTheCountOfCapitalOrSmallLetters(text);
		logger.info("Checked the count of letters");
		extentTest.log(LogStatus.PASS,"Checked the count of letters",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the resetPasswordPage cards properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_the_texts_of_the_footer(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the presence of text in footer",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		FWUtils.checksTheCountOfCapitalOrSmallLetters(text);
		logger.info("Checked the count of letters");
		extentTest.log(LogStatus.PASS,"Checked the count of letters",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the resetPasswordPage footer properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
