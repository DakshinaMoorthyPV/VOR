...
public class Testing_the_feature_for_create_password_page extends Base{
	...
	public void user_checks_the_texts_of_the_header(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the createPasswordPage header properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_the_texts_of_the_cards(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the createPasswordPage cards properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_the_texts_of_the_footer(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the createPasswordPage footer properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
