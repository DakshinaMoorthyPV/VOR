...
public class Testing_the_feature_for_application_selection_page extends Base{
	...
	@Given("User need to be on {string} {string}")
	public void user_need_to_be_on_Beazley_page(String expected, String testName) throws InterruptedException, IOException {
	...
	public void user_checks_the_texts_of_the_header(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the length of text Your Application title in header",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the presence of Beazley Icon in header",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Checked the count of capital and small letters of Your Application in header",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the CSS properties of Your Application title in header",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		logger.info("Validated the Application Selection page header properties");
		extentTest.log(LogStatus.PASS,"Validated the Application Selection page header properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_the_texts_of_the_cards(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the length of text of title Your Applications in cards section",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the presence of text Contact Us in cards section",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		FWUtils.checksTheCountOfCapitalOrSmallLetters(text);
		logger.info("Checked the count of capital and small letters of Your Applications title in Cards section");
		extentTest.log(LogStatus.PASS,"Checked the count of capital and small letters of Your Applications title in Cards section",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the CSS properties of Your Applications title in cards section",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		logger.info("Validated the Application Selection page cards section properties");
		extentTest.log(LogStatus.PASS,"Validated the Application Selection page cards section properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_the_texts_of_the_footer(String text) throws InterruptedException, IOException
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the length of text for Events link in footer",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the presence of Beazley icon in footer",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		FWUtils.checksTheCountOfCapitalOrSmallLetters(text);
		logger.info("Checked the count of capital and small letters of Events link in footer");
		extentTest.log(LogStatus.PASS,"Checked the count of capital and small letters of Events link in footer",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the CSS properties of Events link in footer",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		logger.info("Validated the Application Selection page footer properties");
		extentTest.log(LogStatus.PASS,"Validated the Application Selection page footer properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
	...
	public void user_checks_texts_of_timeout_session_popup(String text) throws InterruptedException, IOException 
	{
		...
		extentTest.log(LogStatus.PASS,"Validated the length of text 'Session due to expire' in timeout session popup",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the presence of text Extend Session in timeout session popup",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		FWUtils.checksTheCountOfCapitalOrSmallLetters(text);
		...
		extentTest.log(LogStatus.PASS,"Checked the count of letters of capital and small letters in 'Session due to expire' text in timeout session popup",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		...
		extentTest.log(LogStatus.PASS,"Validated the CSS properties of text 'Session due to expire' in timeout session popup",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
		logger.info("Validated the timeout session popup properties");
		extentTest.log(LogStatus.PASS,"Validated the timeout session popup properties",extentTest.addScreenCapture(FWUtils.takesScreenShot(driver,photoPath)));
	}
