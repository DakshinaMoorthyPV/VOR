	...
	public WebElement FooterElementDisplayandTextvalidation(WebElement ele, String ExpectedWebElementTextDescription) {
		...
		if (display == true) {
			...
			if(ActualText.equals(ExpectedWebElementTextDescription))
				extentTest.log(LogStatus.PASS,"Verification Successful - Correct text is shown on the FooterSection. ActualText: ---"+ ActualText+ "Expected Text to be shown in UI :"+ ExpectedWebElementTextDescription);
